            ...
            <div
              ...
              className={`flex flex-col items-center gap-3 py-8 text-center ${
                index < features.length - 1
                  ? "lg:border-r lg:border-[#2A2A2A]"
                  : ""
              } ${index < 2 ? "border-b border-[#2A2A2A] lg:border-b-0" : ""} ${
                index === 0 || index === 2
                  ? "border-r border-[#2A2A2A] lg:border-r"
                  : ""
              }`}
            >
              <feature.icon
              ...
              />
              <div>
                <h3 className="text-sm font-medium tracking-wider text-[#FFFFFF]">
                  {feature.title}
                </h3>
                <p className="mt-1 text-xs font-light text-[#A0A0A0]">
                  {feature.description}
                </p>
              </div>
            </div>
